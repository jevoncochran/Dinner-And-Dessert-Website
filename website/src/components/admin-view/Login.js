            ...
            <form style={{ width: '100%' }}>
                <div className="login-cred-div">
                    <div className="login-cred-input-div">
                        ...
                        <input className="login-cred-input" type="text" name="username" onChange={handleInputChange} />
                    </div>
                    <div className="login-cred-input-div">
                        <label htmlFor="password">Password</label>
                        <input className="login-cred-input" type="text" name="password" onChange={handleInputChange} />
                    </div>
                </div>
                <div className="login-other-div">
                    <div className="login-remember-me-div">
                    <input className="login-remember-me-checkbox" type="checkbox" name="remember-me" />
                    <label htmlFor="remember-me">Remember me</label>
                    </div>
                    <p className="login-forgot-p">Forgot password?</p>
                </div>
                <div className="login-submit-btn-div">
                <button className="login-submit-btn" type="submit" onClick={handleLoginSubmit}>SIGN IN</button>
                </div>
            </form>
        </div>
    )
