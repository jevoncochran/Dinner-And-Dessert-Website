...
const ImageShowcase = () => {
    return (
        <div className="img-showcase-container">
            ...
            <p className="img-showcase-img-txt">And on the eighth day, God made mac and cheese and blessed us with the recipe...</p>
            </div>
            <div className="img-showcase-img-container">
            <img src={lambChopDinner} alt="food" className="img-showcase-img" />
            <p className="img-showcase-img-txt">No one does lamb chops like Dinner and Dessert!!!</p>
            </div>
            <div className="img-showcase-img-container">
            <img src={dessert} alt="food" className="img-showcase-img" />
            <p className="img-showcase-img-txt">We dare you to try our desserts and *not* get addicted...</p>
            </div>
            <div className="img-showcase-img-container">
            <img src={jerk_chicken} alt="food" className="img-showcase-img" />
            <p className="img-showcase-img-txt">The best bbq jerk chicken in the D!!!</p>
            </div>
        </div>
    )
}
